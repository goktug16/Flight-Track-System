...
public class BookFlight {
	...
	int[] system_time ;
	public BookFlight(ArrayList<String> routes , ArrayList<String> booked_flights,int[] system_time,ArrayList<Integer> times) {
		this.times = times;
		...
		btnNewButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
					...
					if(check_valid(selected_items))
					{
						...
						booked_flightes.add(route);
						booked_flightes.add(flight_number);
						booked_flightes.add(air);
						booked_flightes.add(departure);
						booked_flightes.add(arrival);
						booked_flightes.add("\n");
						times.add((Integer) comboBox_3.getSelectedItem());
						times.add((Integer) comboBox_2.getSelectedItem());
						times.add((Integer) comboBox_1.getSelectedItem());
						times.add((Integer) comboBox_4.getSelectedItem());
						times.add((Integer) comboBox_5.getSelectedItem());
						times.add((Integer) comboBox_8.getSelectedItem());
						times.add((Integer) comboBox_7.getSelectedItem());
						times.add((Integer) comboBox_6.getSelectedItem());
						times.add((Integer) comboBox_9.getSelectedItem());
						times.add((Integer) comboBox_10.getSelectedItem());
						
						JOptionPane.showMessageDialog(frame, "Your succesfully booked a flight");
					}
					else
